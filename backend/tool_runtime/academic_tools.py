...
from backend.academic_tasks.comparison import (
    ComparisonResult,
    MultiPaperComparator,
    PaperCardRecord,
)
from backend.academic_tasks.drafting import AcademicDrafter, DraftResult
from backend.academic_tasks.literature_review import LiteratureReview, LiteratureReviewService
from backend.academic_tasks.paper_analysis import EvidencePassage, PaperCardExtractor
from backend.academic_tasks.rewriting import AcademicRewriter, RewriteMode, RewriteResult
...
from backend.subagents.paper_reader import PaperCard
