...
description: 提炼由论文证据支持的洞见，并区分事实与推断。 Use when: 寻找启示、趋势或洞见. Do not use when: 复述摘要；无证据头脑风暴.
---
...
- Description: 提炼由论文证据支持的洞见，并区分事实与推断。
- Trigger: 寻找启示、趋势或洞见。
- Do not trigger: 复述摘要；无证据头脑风暴。
- Version: 1.0.0
- Input format: `object`
...
| Tool | 用途 | 何时调用 |
|---|---|---|
| `search_document` | 检索形成洞见所需证据 | 推断前 |
