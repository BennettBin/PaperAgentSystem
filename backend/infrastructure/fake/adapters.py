...
from backend.core.ports.processing import ClaimVerifier, DocumentParser, Retriever, SandboxExecutor
from backend.core.ports.registry import ModelRegistry, ToolRegistry
from backend.core.ports.storage import EventPublisher, ObjectStore
