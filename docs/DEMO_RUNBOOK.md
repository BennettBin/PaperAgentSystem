...
2. **0:35–1:15 — Route and Plan**: show Demo steps 1–2. State that Safe RAG is production default and Plan v1→v2 is a real code-path mechanism fixture, not an effect claim.
...
6. **3:20–4:00 — Decision**: explain why the system did not promote Planner/Multi-Agent and how P02 staging, regression/safety gates and rollback work.

Never describe the experimental path as the production default. Do not show an admin token, prompt text, private paper正文 or hidden reasoning while recording.
